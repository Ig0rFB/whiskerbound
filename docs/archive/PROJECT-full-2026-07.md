...
> **ARCHIVED — July 2026.** Full pre-slim copy. Live truth: repo-root `PROJECT.md`.
> Do not implement from this file; milestone status and as-built systems live in the slim doc.
